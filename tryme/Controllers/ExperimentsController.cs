...
namespace ExperimentCaptcha.Controllers
{
    ...
    {
        private string add = "C:/inetpub/wwwroot/HelperPacer";
...
=======
                db.DraftUsers.Add(draftUser);
                db.SaveChanges();
>>>>>>> 8f2cc6f4999f22f1dbfd070dcff7d74f2b193cd5
            }
            //add_data();
        ...
        string captchaTime)
        {
            ...
            Session["BobNumTrueScore"] = BobNumTrueScore.ToString();
            Session["userNumOfTrueScore"] = userNumOfSucssess.ToString();
            Session["captchaTime"] = captchaTime;
        ...
        public ActionResult SendPersonalInfo(String[] answers, String[] additionalAnswers)
        {
            ...
            si.Q7 = answers[6];
            si.Q8 = answers[7];
            si.Q01 = additionalAnswers[0];
            si.Q02 = additionalAnswers[1];
            si.Q03 = "not relev";
            si.BobNumTrueScore = Session["BobNumTrueScore"].ToString();
            si.userNumOfTrueScore = Session["userNumOfTrueScore"].ToString();
            si.captchaTime = Session["captchaTime"].ToString();
